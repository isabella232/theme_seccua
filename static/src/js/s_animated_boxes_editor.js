odoo.define('theme_common.s_animated_boxes_editor', function (require) {
    ...
    s_options.registry.s_animated_boxes = s_options.Class.extend({
        ...
        add_btn_edit_slide: function () {
            var self = this;
            self.$overlay.data('$optionsSection').append('<a href="#" class="btn-showSlide btn btn-primary" title="Lock slide" style="width: auto; padding: 0 5px;"><i class="fa fa-toggle-off"></i>  Edit Slide</a> ');
